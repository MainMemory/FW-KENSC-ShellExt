...
struct SaxmanAdaptor {
	...
	// marker sequence.
	const static size_t NumTermBits = 0;
	...
	const static size_t DescriptorLittleEndianBits = 1;
	// Size of the search buffer.
	const static size_t SearchBufSize = 4096;
	// Size of the look-ahead buffer.
	const static size_t LookAheadBufSize = 18;
	...
	// or "no edge".
	static size_t dictionary_weight(size_t UNUSED(dist), size_t len) {
		// Preconditions:
